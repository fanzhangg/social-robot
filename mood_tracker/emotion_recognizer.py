...
clf = SVC(kernel='linear', probability=True, tol=1e-5,
          verbose=False)  # Set the classifier as a support vector machines with polynomial kernel
...
def get_files(emotion):  # Define function to get file list, randomly shuffle it and split 80/20
    files = glob.glob("..\\source_images\\dataset\\%s\\*" % emotion)
...
joblib.dump(clf, 'emotion_model.pkl', compress=9)
